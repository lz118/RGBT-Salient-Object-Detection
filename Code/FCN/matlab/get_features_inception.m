...
%
addpath('mex')
img=imread(['E:\MyWorkOnSaliency\matconvnet-1.0-beta19\0001.jpg']);
%     if ~exist('net','var')
%         inital_net;
%     end
    global res;
...
%     end
net1 = dagnn.DagNN.loadobj(load('E:\MyWorkOnSaliency\matconvnet-1.0-beta19\Data\pascal-fcn32s-dag.mat')) ;
